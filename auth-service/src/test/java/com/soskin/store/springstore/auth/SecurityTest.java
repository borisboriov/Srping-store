...
public class SecurityTest {
    ...
    public void securityAccessAllowedTest() throws Exception {
        mockMvc.perform(get("http://localhost:8189/web-market-core/api/v1/products"))
                .andDo(print())
    ...
    public void securityAccessDeniedTest() throws Exception {
        mockMvc.perform(get("http://localhost:8189/web-market-core/api/v1/orders"))
                .andDo(print())
    ...
    public void securityTokenTest() throws Exception {
        ...
        MvcResult result = mockMvc.perform(
                        post("http://localhost:8188/web-market-auth/auth")
                                .content(jsonRequest)
